                            ...
                            <>
                                ...
                                <div className="col-lg-6 mt-2">
                                    <div className="row">
                                        <div className="col product-page-content">
                                            <div className='d-flex gap-2 align-items-center mb-1'>
                                                ...
                                                <i style={{ cursor: 'pointer', fontSize: '20px', color: "#35677a" }} onClick={copyUrlToClipboard} class="fa-solid fa-copy"></i>
                                                {copied && <p style={{ color: 'green', fontSize: '14px', margin: '0' }}>URL copied to clipboard!</p>}
                                            </div>
                                    ...
                                    <div className='d-flex gap-2 justify-content-start'>
                                        <div><button className={productSize === 'sm' ? 'productSizeSelected' : 'productSize'} onClick={() => handleProductSize('sm')}>SM</button></div>
                                        <div><button className={productSize === 'xl' ? 'productSizeSelected' : 'productSize'} onClick={() => handleProductSize('xl')}>XL</button></div>
                                    </div>
                                    <div className="row text-center py-3">
                                        ...
                                        <div className="col-lg-3 col-5">
                                            <button className='button' onClick={() => addProduct({ item: selectedProduct, price: Math.floor(selectedProduct.price - selectedProduct.price / 100 * selectedProduct.discountPercentage) })}>Add To Cart</button>
                                        </div>
                                    ...
                                    <div className="row deliveryPincode">
                                        <input type="number" onChange={handleCheckPincode} placeholder='Enter pincode & check delivery' />
                                        {
                                            pincode.city && <span style={{ fontSize: "14px", fontFamily: "monospace" }}>Delivery available in {pincode.city.toLowerCase()},  {pincode.district}</span>
                                        }
                                    </div>
